...
# Introduction
China's remarkable economic growth over the past five decades was initiated by the reform and opening-up policy launched in 1978, transitioning the country from a centrally planned to a market-oriented economy. From the openning up in 1978 to 2024, China's GDP growth rate averaged over 9% per year, and 800 million people were lifted out of poverty, with considerable improvment in the nation's health and education [@world_bank_world_2024]. This growth, however, has not been uniform across time, geography, or economic sectors. Coastal provinces such as Jiangsu and Guangdong experienced substantially higher growth rates, benefiting from early exposure to foreign investment and trade, while inland and rural areas lagged, leading to pronounced regional disparities [@liao_sixty_2016]. Sectorally, China's strong growth has been driven by fixed-capital investment and export-oriented manufacuring, which althoug effective in the past, start to show signs of both domestic and international imbalances [@world_bank_world_2024]. Since 2010, China's annual GDP growth rate has been declining from 10.6% in 2011 to 5.2% in 2023[@world_bank_gdp_2025]. 

Concurrently, China experienced a substantial rise in wealth and income inequality. The wealth share controlled by the top 10% increased markedly from approximately 40% in the late 1970s to nearly 70% by 2015, while the share held by the bottom half significantly decreased [@piketty_capital_2019]. Some studies indicate that China's overall inequality reached its peak around 2010, after which it started to gradually decline [@kanbur_great_2021; @zhang_survey_2021]. Additionally, it is well-established that China's inequality closely correlates with its urban-rural and coastal-inland divisions, with urban and coastal regions exhibiting substantially higher levels of income and wealth compared to their rural and inland counterparts [@piketty_capital_2019; @zhang_survey_2021].

This paper analyzes the contemporary landscape of wealth inequality in China using recent data from the 2017 and 2019 China Household Finance Survey (CHFS). It specifically investigates whether recent trends confirm claims of continued inequality reduction since 2010. Through factor decomposition, the study examines the sources of wealth inequality within the entire population as well as separately within urban-rural and coastal-inland subgroups, highlighting variations in inequality among these different groups. Furthermore, the study applies group decomposition methods to assess the extent to which rural-urban and coastal-inland disparities contribute to overall wealth inequality. Through these detailed decompositions and analyses, the paper aims to provide a comprehensive and nuanced understanding of current patterns and dynamics in China's wealth inequality.
...
The CHFS dataset has been extensively utilized in academic research. Studies leveraging the CHFS data have explored topics ranging from wealth distribution and inequality [@tan_earnings_2017], household finance in rural China [@gan_report_2014], household medical insurance expenditure [@liu_health_2022], and many others.
